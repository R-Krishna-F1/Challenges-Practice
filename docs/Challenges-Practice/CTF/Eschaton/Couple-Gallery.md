...
| Tool | What it does | Output quality |
| --- | --- | --- |
| `hbc-disassembler` | Converts to **assembly-like** code | Low level, hard to read |
| `hbc-decompiler` | Converts to **pseudo JavaScript** | Readable, preserves strings |
